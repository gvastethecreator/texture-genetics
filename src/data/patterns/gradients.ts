import gradientRadialGlsl from './glsl/gradients/gradient_radial.glsl?raw';
import gradientStripesGlsl from './glsl/gradients/gradient_stripes.glsl?raw';
import gradientLinearGlsl from './glsl/gradients/gradient_linear.glsl?raw';
