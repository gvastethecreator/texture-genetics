import perlinNoiseGlsl from './glsl/noise/perlin_noise.glsl?raw';
import simplexNoiseGlsl from './glsl/noise/simplex_noise.glsl?raw';
import cellularNoiseGlsl from './glsl/noise/cellular_noise.glsl?raw';
import worleyNoiseGlsl from './glsl/noise/worley_noise.glsl?raw';
import gradientNoiseGlsl from './glsl/noise/gradient_noise.glsl?raw';
import valueNoiseGlsl from './glsl/noise/value_noise.glsl?raw';
import ridgedFractalGlsl from './glsl/noise/ridged_fractal.glsl?raw';
import voronoiSmoothGlsl from './glsl/noise/voronoi_smooth.glsl?raw';
import trabeculumGlsl from './glsl/noise/trabeculum.glsl?raw';
import turbulenceGlsl from './glsl/noise/turbulence.glsl?raw';
import gyroidGlsl from './glsl/noise/gyroid.glsl?raw';
import curlNoiseGlsl from './glsl/noise/curl_noise.glsl?raw';
import marbleGlsl from './glsl/noise/marble.glsl?raw';
import woodGlsl from './glsl/noise/wood.glsl?raw';
import grungeGlsl from './glsl/noise/grunge.glsl?raw';
import squigglesGlsl from './glsl/noise/squiggles.glsl?raw';
import holoFoilGlsl from './glsl/noise/holo_foil.glsl?raw';
import furFibersGlsl from './glsl/noise/fur_fibers.glsl?raw';
