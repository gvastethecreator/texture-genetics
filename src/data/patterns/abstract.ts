import scanlinesGlsl from './glsl/abstract/scanlines.glsl?raw';
import magicCircleGlsl from './glsl/abstract/magic_circle.glsl?raw';
import mandalaGlsl from './glsl/abstract/mandala.glsl?raw';
import electricGlsl from './glsl/abstract/electric.glsl?raw';
import binaryMatrixGlsl from './glsl/abstract/binary_matrix.glsl?raw';
import explosionGlsl from './glsl/abstract/explosion.glsl?raw';
import radialWaveGlsl from './glsl/abstract/radial_wave.glsl?raw';
import circuitGlsl from './glsl/abstract/circuit.glsl?raw';
import mandelbrotGlsl from './glsl/abstract/mandelbrot.glsl?raw';
import juliaGlsl from './glsl/abstract/julia.glsl?raw';
import flowFieldGlsl from './glsl/abstract/flow_field.glsl?raw';
import infiniteFallGlsl from './glsl/abstract/infinite_fall.glsl?raw';
import voxelTunnelGlsl from './glsl/abstract/voxel_tunnel.glsl?raw';
import hypnoticRingsGlsl from './glsl/abstract/hypnotic_rings.glsl?raw';
import metaballSpiralGlsl from './glsl/abstract/metaball_spiral.glsl?raw';
import inverseMobiusGlsl from './glsl/abstract/inverse_mobius.glsl?raw';
import stereoFlowGlsl from './glsl/abstract/stereo_flow.glsl?raw';
import smoothSwirlGlsl from './glsl/abstract/smooth_swirl.glsl?raw';
import neonRipplesGlsl from './glsl/abstract/neon_ripples.glsl?raw';
import gaborNoiseGlsl from './glsl/abstract/gabor_noise.glsl?raw';
