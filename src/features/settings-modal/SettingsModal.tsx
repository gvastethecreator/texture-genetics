...
import { Label, Slider, Toggle, ActionButton } from '../../shared/ui/Elements';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, state, updateState, updateSettings }) => {
    ...
    return (
        ...
        >
            <div className="bg-[#0D0D0D] border border-border w-full max-w-lg rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="flex items-center justify-between p-5 border-b border-border bg-[#151515]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-black text-gray-100 uppercase tracking-widest">Global Settings</h2>
                ...
                <div className="p-6 space-y-6 overflow-y-auto max-h-[70vh] custom-scrollbar">
                    ...
                    <div className="space-y-3">
                         <div className="flex items-center gap-2 mb-2 text-accent-primary">
                             <Icons.Cpu size={14} />
                             <span className="text-xs font-bold uppercase tracking-wide">Renderer Performance</span>
                         </div>
                         <div className="p-4 bg-black/30 rounded-lg border border-white/5 space-y-4">
                            ...
                            <div className="pt-3 border-t border-white/5">
                                <Label label="Pixel Ratio (DPR)" description="Screen pixel density. Native = Sharpest." />
                                <div className="flex gap-2 mb-2">
                                     {[0, 1, 1.5, 2].map(dpr => (
                                         <button 
                                            key={dpr}
