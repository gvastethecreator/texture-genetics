  ...
  ({
    ...
    return (
      <div className="h-full bg-panel flex flex-col border-l border-border">
        ...
        {/* SCROLLABLE CONTENT */}
        <div
          className="flex-1 overflow-y-auto overflow-x-hidden p-3 space-y-1 scrollbar-thin pb-24 md:pb-6"
            ...
            <div className="animate-in fade-in slide-in-from-right-2 duration-200 space-y-1">
              ...
              <div className="mt-4 p-4 border border-dashed border-white/10 rounded-lg text-center">
                ...
                <p className="text-[10px] text-gray-500">
                  Scene settings affect the 3D preview viewport but are not applied to the exported
                  texture maps (except Video/GIF/Screenshot).
                </p>
              </div>
            </div>
          )}
