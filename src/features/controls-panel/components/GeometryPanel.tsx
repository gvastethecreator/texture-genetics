...
export const GeometryPanel: React.FC<GeometryPanelProps> = memo(({ state, updateStateGroup, onCommit }) => {
    ...
    return (
        <ControlSection title="Geometry Settings" icon={state.geometry === GeometryType.SVG ? PenTool : Type} color="#F59E0B" defaultOpen={true}>
