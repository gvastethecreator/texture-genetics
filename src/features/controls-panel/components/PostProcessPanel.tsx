      ...
      <ControlSection title="Post FX & Distortion" icon={Icons.Fingerprint} color="#8B5CF6">
        <div className="p-2 mb-3 bg-purple-900/20 border border-purple-500/30 rounded">
          ...
          <p className="text-[9px] text-purple-300 mt-1 leading-tight">
            If OFF, effects like Glitch, Bloom, and Grading only appear in the 3D Preview (Render
            Mode), not the exported map.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <Label label="Seed (Offset)" />
            <Slider
              min={0}
              max={100}
              step={1}
              value={state.params.seed}
              onChange={(v) => updateStateGroup("params", { seed: v })}
              onCommit={onCommit}
            />
          </div>
          ...
          <div className="pt-2 border-t border-white/5">
            <Toggle
              label="Normalize Output (0-1)"
              checked={state.postProcess.normalize}
              onChange={(v) => updateStateGroup("postProcess", { normalize: v })}
              onCommit={onCommit}
            />
          </div>
          ...
          <div className="pt-2 border-t border-white/5 mt-2 space-y-3">
            ...
            {/* Halftone */}
            <Toggle
              label="Halftone (Dot Matrix)"
              checked={state.postProcess.halftone}
              onChange={(v) => updateStateGroup("postProcess", { halftone: v })}
              onCommit={onCommit}
            />
            {state.postProcess.halftone && (
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in">
                ...
                <Slider
                  ...
                  max={150}
                  step={5}
                  value={state.postProcess.halftoneScale}
                  onChange={(v) => updateStateGroup("postProcess", { halftoneScale: v })}
                  onCommit={onCommit}
                />
              </div>
            )}
            ...
            <Toggle
              label="Neon Edges"
              checked={state.postProcess.edgeDetect}
              onChange={(v) => updateStateGroup("postProcess", { edgeDetect: v })}
              onCommit={onCommit}
            />
            {state.postProcess.edgeDetect && (
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in">
                <ColorPicker
                  label="Edge Color"
                  color={state.postProcess.edgeColor}
                  onChange={(c) => updateStateGroup("postProcess", { edgeColor: c })}
                  onCommit={onCommit}
                />
              </div>
            )}
          ...
          <div className="pt-2 border-t border-white/5 space-y-2">
            <Toggle
              label="Luma Alpha Mask"
              checked={state.imageAlpha.enabled}
              onChange={(v) => updateStateGroup("imageAlpha", { enabled: v })}
              onCommit={onCommit}
            />
              ...
              <div className="mt-2 pl-2 border-l-2 border-accent-primary/20 space-y-2 animate-in fade-in">
                <div>
                  ...
                  <Slider
                    min={0}
                    max={1}
                    value={state.imageAlpha.threshold}
                    onChange={(v) => updateStateGroup("imageAlpha", { threshold: v })}
                    onCommit={onCommit}
                  />
                </div>
                <div>
                  ...
                  <Slider
                    min={0}
                    max={0.5}
                    value={state.imageAlpha.tolerance}
                    onChange={(v) => updateStateGroup("imageAlpha", { tolerance: v })}
                    onCommit={onCommit}
                  />
                </div>
                <div>
                  <Label label="Blur Edge" />
                  <Slider
                    min={0}
                    max={0.2}
                    value={state.imageAlpha.blur}
                    onChange={(v) => updateStateGroup("imageAlpha", { blur: v })}
                    onCommit={onCommit}
                  />
                </div>
              </div>
        ...
        <div className="pt-3 border-t border-white/10 mt-3 space-y-3">
          ...
          <Toggle
            ...
            checked={state.postProcess.polar}
            onChange={(v) => updateStateGroup("postProcess", { polar: v })}
            onCommit={onCommit}
          />
          ...
          <div className="pt-2 border-t border-white/5">
            <Toggle
              label="Bloom"
              checked={state.postProcess.bloom}
              onChange={(v) => updateStateGroup("postProcess", { bloom: v })}
              onCommit={onCommit}
            />
              ...
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in mt-1 space-y-2">
                <div>
                  ...
                  <Slider
                    ...
                    max={1}
                    step={0.01}
                    value={state.postProcess.bloomThreshold}
                ...
                <div>
                  ...
                  <Slider
                    ...
                    max={2}
                    step={0.1}
                    value={state.postProcess.bloomStrength}
          ...
          <div className="pt-2 border-t border-white/5">
            <Toggle
              label="Gaussian Blur"
              checked={state.postProcess.blur}
              onChange={(v) => updateStateGroup("postProcess", { blur: v })}
              onCommit={onCommit}
            />
            {state.postProcess.blur && (
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in mt-1">
                ...
                <Slider
                  ...
                  max={5}
                  step={0.1}
                  value={state.postProcess.blurStrength}
          ...
          <div className="pt-2 border-t border-white/5">
            <Toggle
              label="Toon Shading (Cell)"
              checked={state.postProcess.toon}
              onChange={(v) => updateStateGroup("postProcess", { toon: v })}
              onCommit={onCommit}
            />
            {state.postProcess.toon && (
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in mt-1">
                <Label label="Quantize Levels" />
                <Slider
                  min={2}
                  max={10}
                  step={1}
                  value={state.postProcess.toonLevels}
                  onChange={(v) => updateStateGroup("postProcess", { toonLevels: v })}
                  onCommit={onCommit}
                />
              </div>
            )}
          ...
          <div className="pt-2 border-t border-white/5">
            <Toggle
              label="Posterize"
              checked={state.postProcess.posterize}
              onChange={(v) => updateStateGroup("postProcess", { posterize: v })}
              onCommit={onCommit}
            />
            {state.postProcess.posterize && (
              <div className="pl-2 border-l-2 border-accent-primary/20 animate-in fade-in mt-1">
                <Label label="Color Levels" />
                <Slider
                  min={2}
                  max={32}
                  step={1}
                  value={state.postProcess.posterizeLevels}
                  onChange={(v) => updateStateGroup("postProcess", { posterizeLevels: v })}
                  onCommit={onCommit}
                />
              </div>
            )}
          ...
          <div className="pt-2 border-t border-white/5 space-y-2">
            <div>
              ...
              <Slider
                ...
                max={1}
                step={0.01}
                value={state.postProcess.chromaticAberration}
            ...
            <div>
              ...
              <Slider
                min={0}
                max={1}
                value={state.postProcess.radialMask}
            ...
            <div>
              ...
              <Slider
                min={0}
                max={1}
                value={state.postProcess.vignette}
