...
export const InteractivePanel: React.FC<InteractivePanelProps> = memo(
      ...
      <ControlSection title="Interactive" icon={Icons.MousePointer2} color="#F59E0B">
        <div className="space-y-3">
          <Toggle
            ...
            checked={state.mouse.enabled}
            onChange={(v) => updateStateGroup("mouse", { enabled: v })}
            onCommit={onCommit}
          />
          ...
          {state.mouse.enabled && (
            <div className="mt-2 pl-2 border-l-2 border-accent-primary/20 space-y-3 animate-in fade-in">
              <div className="relative">
                ...
                <Icons.ChevronDown
                  size={12}
                  className="absolute right-2 top-[22px] text-gray-500 pointer-events-none"
                />
              </div>
              <div>
                ...
                <Slider
                  ...
                  onChange={(v) => updateStateGroup("mouse", { strength: v })}
                  onCommit={onCommit}
                />
              </div>
              <div>
                ...
                <Slider
                  ...
                  onChange={(v) => updateStateGroup("mouse", { radius: v })}
                  onCommit={onCommit}
                />
              </div>
            </div>
