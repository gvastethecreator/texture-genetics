      ...
      <ControlSection title="Transform & Tile" icon={Icons.Move} color="#10B981">
        ...
        <div className="mt-4 pt-3 border-t border-white/5 space-y-3">
          ...
          <Toggle
            ...
            checked={state.symmetry.enabled}
            onChange={(v) => updateStateGroup("symmetry", { enabled: v })}
            onCommit={onCommit}
          />
            ...
            <div className="pl-2 border-l-2 border-accent-primary/20 space-y-2 animate-in fade-in">
              <div>
                ...
                <Slider
                  ...
                  max={16}
                  step={1}
                  value={state.symmetry.segments}
                  onChange={(v) => updateStateGroup("symmetry", { segments: v })}
                  onCommit={onCommit}
                />
              </div>
              <div>
                ...
                <Slider
                  ...
                  max={3.0}
                  step={0.1}
                  value={state.symmetry.zoom}
                  onChange={(v) => updateStateGroup("symmetry", { zoom: v })}
                  onCommit={onCommit}
                />
              </div>
              <div>
                ...
                <Slider
                  ...
                  max={360}
                  step={1}
                  value={state.symmetry.rotation}
                  onChange={(v) => updateStateGroup("symmetry", { rotation: v })}
                  onCommit={onCommit}
                />
              </div>
            </div>
        ...
        <div className="mt-4 pt-3 border-t border-white/5 space-y-3">
          <div className="flex items-center justify-between">
            <Toggle
              ...
              checked={state.tiling.enabled}
              onChange={(v) => updateStateGroup("tiling", { enabled: v })}
              onCommit={onCommit}
            />
            <button
          ...
          {state.tiling.enabled && (
            <div className="space-y-3 mt-2 animate-in fade-in zoom-in-95 bg-black/20 p-2 rounded">
              ...
              <div className="flex justify-between items-center mb-2">
                <Toggle
                  label="Show Grid"
                  checked={state.tilingPreview}
                  onChange={(v) => onChangeState({ tilingPreview: v })}
                />
                <Toggle
                  label="Mirror"
                  checked={state.tiling.mirror}
                  onChange={(v) => updateStateGroup("tiling", { mirror: v })}
                  onCommit={onCommit}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pb-2 border-b border-white/5">
                <div>
                  <Label label="Repeat X" />
                  <Slider
                    min={1}
                    max={10}
                    step={1}
                    value={state.tiling.repeatX}
                    onChange={(v) => updateStateGroup("tiling", { repeatX: v })}
                    onCommit={onCommit}
                  />
                </div>
                <div>
                  <Label label="Repeat Y" />
                  <Slider
                    min={1}
                    max={10}
                    step={1}
                    value={state.tiling.repeatY}
                    onChange={(v) => updateStateGroup("tiling", { repeatY: v })}
                    onCommit={onCommit}
                  />
                </div>
              </div>
                ...
                <div className="space-y-2 pl-1">
                  <div>
                    ...
                    <Slider
                      min={0.1}
                      max={3.0}
                      value={state.tiling.scale}
                      onChange={(v) => updateStateGroup("tiling", { scale: v })}
                      onCommit={onCommit}
                    />
                  </div>
                  <div>
                    ...
                    <Slider
                      ...
                      max={360}
                      step={1}
                      value={state.tiling.rotation}
                      onChange={(v) => updateStateGroup("tiling", { rotation: v })}
                      onCommit={onCommit}
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <Slider
                        min={-1}
                        max={1}
                        value={state.tiling.offsetX}
                        onChange={(v) => updateStateGroup("tiling", { offsetX: v })}
                        onCommit={onCommit}
                      />
                    </div>
                    <div>
                      ...
                      <Slider
                        min={-1}
                        max={1}
                        value={state.tiling.offsetY}
                        onChange={(v) => updateStateGroup("tiling", { offsetY: v })}
                        onCommit={onCommit}
                      />
                    </div>
                  </div>
