...
export const Controls: React.FC<LeftControlsProps> = memo(({ state, actions, history }) => {
  ...
  const updateBalance = useCallback(
    (key: keyof AppState["colorBalance"], val: number | object, channel?: "r" | "g" | "b") => {
  ...
  return (
    ...
    <div
      className="h-full bg-panel overflow-y-auto overflow-x-hidden p-3 space-y-1 scrollbar-thin pb-24 md:pb-6 border-r border-border"
    ...
    >
      ...
      <GeometryPanel state={state} updateStateGroup={updateStateGroup} onCommit={history.commit} />
